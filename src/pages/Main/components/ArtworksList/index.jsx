...
//utils
import {ASC, DD_MM_YYYY, DESC, localeTimePath} from 'utils/constants';
//styles
			...
			<table className={styles.table}>
				<thead>
					<tr>
						...
						>
							Artwork Name {renderSortIcon('artwork_name', sortField, sortDirection, ASC)}
						</th>
						<th
						...
						>
							Artist Name {renderSortIcon('artist_name', sortField, sortDirection, ASC)}
						</th>
						<th
						...
						>
							Years {renderSortIcon('creation_year', sortField, sortDirection, ASC)}
						</th>
							...
							<tr>
								<td>
									<picture>
										...
										<source
											srcSet={`images/${artwork.main_photo.filename_disk}`}
								...
								<td className={styles.artworkTitle}>
									...
									{artwork.has_notifications && <span className={styles.notificationDot}></span>}
								</td>
								...
								<td>{`$ ${artwork.price.toLocaleString(localeTimePath)}`}</td>
								<td>{renderDocuments(artwork.documents_number)}</td>
								<td>{dayjs(artwork.date_created).format(DD_MM_YYYY)}</td>
							</tr>
